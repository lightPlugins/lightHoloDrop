...
public class SurvivalCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if(args.length == 1) {
            ...
            Ashura.util.sendMessage(player,
                    "&7Du hast den Spielmodus von #dc143d" + args[0] + " &7auf #dc143dSurvival &7gesetzt");
            Ashura.util.sendMessage(target,
                    "&7Dein Spielmodus wurde auf #dc143dSurvival &7gesetzt");
        ...
        if(args.length == 0) {
            ...
            Ashura.util.sendMessage(player,
                    "&7Du hast deinen Spielmodus auf #dc143dSurvival &7gesetzt");
